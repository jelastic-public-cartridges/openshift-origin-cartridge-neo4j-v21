...
Welcome to Neo4j release 2.1.2, a high-performance graph database.
...
For full instructions, see http://docs.neo4j.org/chunked/2.1.2/deployment.html
...
* Getting Started: http://docs.neo4j.org/chunked/2.1.2/introduction.html
* The Neo4j Manual (online): http://docs.neo4j.org/chunked/2.1.2/
